        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-10">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-[11px] font-bold text-stone-900 uppercase tracking-widest">Détails du Showroom</h3>
            </div>
            
            <div className="space-y-4">
              <div>
                <label className="block text-[11px] font-bold text-stone-400 uppercase tracking-widest mb-2">Nom du Showroom</label>
                <input 
                  type="text" 
                  disabled
              ...
              <div>
                <label className="block text-[11px] font-bold text-stone-400 uppercase tracking-widest mb-2">Showroom Manager</label>
                <input 
                  type="text" 
                  disabled
