    ...
    <div className="flex flex-col items-end justify-between py-2">
      ...
      <div className="flex items-start gap-8 mb-6">
        ...
        <div className="flex flex-col items-end justify-center pt-2">
          <span className="text-[10px] text-stone-400 uppercase font-bold tracking-[0.2em] mb-1.5">Score Global</span>
          <span className={`text-[9px] font-bold uppercase tracking-widest px-2.5 py-0.5 rounded-full ${badgeClasses}`}>
            {performanceStatus}
          </span>
        </div>
        <div className="flex items-baseline gap-1.5">
          <span className="font-mono text-[72px] leading-[0.8] font-bold text-stone-900 tracking-tighter">{totalScore}</span>
          <span className="font-mono text-[16px] font-bold text-stone-300">/ 100</span>
        </div>
      </div>

      {/* Bottom part: Breakdown with subtle progress bars */}
      <div className="flex gap-8">
        <div className="flex flex-col gap-2 border-r border-stone-100 pr-8">
