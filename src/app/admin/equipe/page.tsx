...
export default function TeamPage() {
  ...
  return (
    <>
      ...
      <footer className="px-12 py-10 border-t border-stone-100 flex justify-between items-center bg-white">
        <p className="font-mono text-[10px] text-stone-400 uppercase tracking-[0.2em]">© 2024 ShowroomIQ Intelligence — Team Management Protocol</p>
      </footer>
    </>
  );
}
